...
namespace doan1.Data.Cart
{
    public class ShoppingCart
    {
        ...
        public int GetShoppingCartTotal() => _context.ShoppingCartItems.Where(n => n.ShoppingCartId == ShoppingCartId).Select(n => n.Product.Price * n.Amount).Sum();
